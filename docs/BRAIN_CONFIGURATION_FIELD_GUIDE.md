...
| 2026-07-15 | A single ranked complete manifest must outrank raw similarity for one-language requests; unified enterprise passed `11/11` suites with no tick mutation after the correction. | Proven live | `runtime/benchmarks/enterprise-retention-after-ranked-manifest.json` |
