...
Sources:
  ...
  - 5 major curriculum design frameworks (ADDIE, UbD, Gagne, PBL, UDL)
...
LEARNING_PRINCIPLES = [
    ...
    },
    {
        ...
        'example': 'Students who generated explanations for facts (e.g., "Why would whales have blubber?") remembered them 2x better than students who simply read the answers.',
    },
    {
    ...
    },
    {
        ...
        'example': 'Novice algebra students learned 2x more from studying worked examples than from solving equivalent problems (Sweller & Cooper 1985).',
    },
    {
    ...
    },
    {
        ...
        'evidence': 'Ericsson, Krampe & Tesch-Romer (1993). Foundation of expertise research.',
        ...
        'example': 'Chess grandmasters spent 4x more time on deliberate study of difficult positions than average players, with same total practice hours (Charness et al. 2005).',
    },
    {
    ...
    },
    {
        ...
        'example': 'Students who slept after learning a grammar rule and tested 12 hours later retained 2x more than those who stayed awake for 12 hours before testing.',
    },
    {
        ...
        'example': 'Students who compared two analogous examples of a negotiation principle transferred the strategy to a novel scenario 2x more often than those who studied only one example (Gentner et al. 2003).',
    },
    {
        'name': 'Social Learning and Peer Instruction',
        'evidence': 'Bandura (1977); Mazur (1997) peer instruction. Strong classroom evidence.',
        'mechanism': 'Learning through observation of models and peer explanation. Explaining to a peer forces deeper encoding ("protege effect"). Listening to a peer who recently learned something can be more effective than expert explanation -- peer has recently navigated the same confusions.',
        ...
        'example': 'Mazur\'s peer instruction in physics increased conceptual understanding gains by 2x compared to traditional lecture (Crouch & Mazur 2001).',
    },
    {
    ...
    },
    {
        ...
        'example': 'Students who exercised before vocabulary learning showed 20% better vocabulary retention than sedentary students (Hotting & Roder 2013).',
    },
    {
    ...
    },
    {
        ...
        'example': 'Phone numbers are memorized as 3 chunks (555) (867) (5309) -- not 10 individual digits. Meaningfully chunked information is 3x more memorable.',
    },
    {
        ...
        'example': 'Students given a brief overview of a passage\'s topic before reading recalled 2x more information than students who read without an advance organizer (Mayer 1979).',
    },
    {
...
Each Bloom's level can operate on any knowledge type, creating a 4x6 grid for lesson design.
"""
...
Robert Gagne (1965). "Conditions of Learning." Highly structured, evidence-based sequence.
...
def train_stage35(node: str, data_dir: str, args):
    ...
    if bloom_key not in trained_wiki:
        ...
        if _train(node, BLOOMS_TAXONOMY, session):
            ...
            print("  [ok] Bloom's Taxonomy trained.")
    ...
    if fw_key not in trained_wiki:
        ...
        if _train(node, CURRICULUM_FRAMEWORKS, session):
            ...
            print('  [ok] Curriculum frameworks trained.')
        _save_checkpoint(ckpt_wiki, trained_wiki)
    ...
    if ai_key not in trained_wiki:
        ...
        if _train(node, AI_CURRICULUM_DESIGN, session):
            ...
            print('  [ok] AI curriculum design guide trained.')
        _save_checkpoint(ckpt_wiki, trained_wiki)
        ...
        for topic in topics:
            ...
            if text:
                ...
                if _train(node, full, session):
                    ...
                    print(f'  [{done}/{total}] [ok] {branch}: {topic}')
            time.sleep(0.15)
        _save_checkpoint(ckpt_wiki, trained_wiki)
    ...
    for query in PEDAGOGY_PUBMED_QUERIES:
        ...
        print(f'  [ok] PubMed: {query} ({len(pmids)} articles)')
        time.sleep(rate)
