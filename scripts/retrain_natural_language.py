...
The JSON training corpus (800 batches x 10 candidates) caused the node to
...
PAIRS: list[tuple[str, str]] = [
    ...
    ("What is gravity?", "Gravity is a fundamental force of attraction between objects with mass. On Earth, it pulls objects toward the planet's center with an acceleration of 9.8 m/s^2."),
    ...
    ("What is the speed of light?", "The speed of light in a vacuum is approximately 299,792,458 meters per second, or about 3x10⁸ m/s."),
    ...
    # Mathematics
    ("What is Pi?", "Pi (pi) is the mathematical constant representing the ratio of a circle's circumference to its diameter, approximately equal to 3.14159265358979."),
...
def main():
    ...
    total = len(PAIRS)
    print(f"Rebalancing with {total} natural-language QA pairs x {args.repeats} repeats = {total * args.repeats} total ingestions")
