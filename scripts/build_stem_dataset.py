...
WIKI_STEM_ARTICLES = [
    ...
    # Physics
    "Newton's_laws_of_motion", 'Maxwell_equations', 'Schrödinger_equation',
    ...
    "Schrödinger_equation", 'Double-slit_experiment', 'Bell_theorem',
...
CAD_3D_TEXT_CORPUS = [
    ...
    ('finite_element_method', 'Finite Element Analysis (FEA): '
     ...
     'Solve: [K]{u} = {F} (stiffness matrix × displacement = force vector). '
...
ELECTRONICS_TEXT_CORPUS = [
    ...
    ('circuit_theory',
     ...
     'Capacitor: I = C·dV/dt. Energy = ½CV². Impedance Xc = 1/(2πfC). '
     'Inductor: V = L·dI/dt. Energy = ½LI². Impedance XL = 2πfL. '
     ...
     'RLC resonance: f0 = 1/(2π√(LC)). Q factor = (1/R)√(L/C).'),
    ...
    ('semiconductors_transistors',
     ...
     'Active: VCE > VCE_sat, IC = β·IB (current amplifier, β typically 50-300). '
    ...
    ('operational_amplifiers',
     ...
     'Voltage follower (buffer): Vout = Vin. Rf=0, R1=∞. '
...
EMBEDDED_TEXT_CORPUS = [
    ...
    ('systems_engineering',
     ...
     'FMEA Risk Priority Number (RPN) = Severity × Occurrence × Detectability. '
    ...
    ('communication_protocols_embedded',
     ...
     'Modes 0-3: CPOL (clock polarity) × CPHA (clock phase). '
...
EMBEDDED_WIKI_ARTICLES = [
    ...
    'Quantum_computing', "Schrödinger's_cat", 'Double-slit_experiment',
...
STEM_QA_PAIRS = [
    ...
    ('What is IEEE 754 floating point?', 'IEEE 754 is the standard for binary floating-point. 32-bit: 1 sign bit, 8 exponent bits (bias 127), 23 mantissa bits. Represents fractions as 1.mantissa × 2^(exp-127). Special values: ±infinity, NaN.'),
